...
-(void)buildTags{
    ...
    for (int i = 0; i<_dataA.count; i++) {
        ...
        UIButton *button =[UIButton LXButtonNoFrameWithTitle:_dataA[i] titleFont:self.tagFont Image:nil backgroundImage:nil backgroundColor:kWhiteColor titleColor:APP_COMMON_COLOR];
        [button lh_setCornerRadius:3 borderWidth:1 borderColor:APP_COMMON_COLOR];
...
-(void)layoutItems{
    ...
    CGFloat allWidth = kScreenWidth-150;//总宽度
