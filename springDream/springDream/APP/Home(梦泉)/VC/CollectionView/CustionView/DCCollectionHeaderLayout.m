...
- (CGSize)collectionViewContentSize {
    ...
    if (self.delegate &&[self.delegate respondsToSelector:@selector(collectionViewDynamicCollectionViewHeight:)]) {
        [self.delegate collectionViewDynamicCollectionViewHeight:self.contentHeight + self.itemInset.bottom];
    }
