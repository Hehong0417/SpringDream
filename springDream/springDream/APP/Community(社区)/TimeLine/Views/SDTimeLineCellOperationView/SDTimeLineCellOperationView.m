...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        _likeButton =  [self creatButtonWithTitle:@"点赞(200)" image:[UIImage imageNamed:@"tip_01"] selImage:[UIImage imageNamed:@"tip_02"] target:self selector:@selector(likeButtonAction:)];
