...
+(NSDictionary *)mj_objectClassInArray{
    ...
    return @{@"SKUValues": [HHproduct_sku_valueModel class],@"SKUList": [HHproduct_skuModel class],
             @"AttributeValueList" :[HHattributeValueModel class],@"Packages":[HHPackagesModel class],@"MeetActivity":[MeetActivityModel class],@"Coupons":[MeetActivityModel class],@"AllSkuList": [HHproduct_skuModel class]};
}
...
@end
@implementation MeetActivityModel
