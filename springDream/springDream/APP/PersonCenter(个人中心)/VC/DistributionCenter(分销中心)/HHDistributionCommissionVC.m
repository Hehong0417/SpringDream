...
- (void)viewDidLoad {
    ...
    HHDistributionCommissionHead *distributionCommissionHead = [[[NSBundle mainBundle] loadNibNamed:@"HHDistributionCommissionHead" owner:self options:nil] firstObject];
    distributionCommissionHead.backgroundColor = kWhiteColor;
    self.tabView.tableHeaderView = distributionCommissionHead;
