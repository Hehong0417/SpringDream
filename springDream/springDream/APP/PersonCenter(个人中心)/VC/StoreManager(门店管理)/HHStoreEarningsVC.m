...
@interface HHStoreEarningsVC ()<DZNEmptyDataSetDelegate,DZNEmptyDataSetSource>
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
    ...
    UILabel *remark = [UILabel lh_labelWithFrame:CGRectMake(20, 0, ScreenW/2, 50) text:@"门店奖励：00.00" textColor:kDarkGrayColor font:FONT(12) textAlignment:NSTextAlignmentLeft backgroundColor:kWhiteColor];
    [Footer addSubview:remark];
    UILabel *remark2 = [UILabel lh_labelWithFrame:CGRectMake(ScreenW/2+50, 0, ScreenW/2-45, 50) text:@"门店返利：00.00" textColor:kDarkGrayColor font:FONT(12) textAlignment:NSTextAlignmentLeft backgroundColor:kWhiteColor];
