...
@interface HHStoreOrderVC ()<UIScrollViewDelegate,UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate,NewApplyRefundDelegate>
...
- (void)getDatasWithIndex:(NSNumber *)index{
    ...
    [[[HHMineAPI GetStoreOrderWithPage:@(self.page) pageSize:@20] netWorkClient] getRequestInView:nil finishedBlock:^(HHMineAPI *api, NSError *error) {
        self.isLoading = YES;
