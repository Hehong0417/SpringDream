...
@interface HHDelegateOrderVC ()<UIScrollViewDelegate,UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate,NewApplyRefundDelegate>
...
@end
@implementation HHDelegateOrderVC
