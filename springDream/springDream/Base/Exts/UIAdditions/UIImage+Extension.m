...
- (UIImage *)cutPictureWithRect:(CGRect)rect image:(UIImage*)oriImage{

    CGImageRef cgRef = oriImage.CGImage;
    CGImageRef imageRef = CGImageCreateWithImageInRect(cgRef, rect);
    UIImage *thumbScaleImage = [UIImage imageWithCGImage:imageRef];
    CGImageRelease(imageRef);

    return thumbScaleImage;
}
