...
//遮罩
@property (nonatomic, weak) UIView *toshadowView;
    ...
    [UIView animateKeyframesWithDuration:self.toDuration delay:0.0 options:0 animations:^{
        if (_flipEnable) {
            ...
            [UIView addKeyframeWithRelativeStartTime:0.0 relativeDuration:0.75 animations:^{
                ...
                shadowView.transform = CGAffineTransformScale(fromTempView.transform, _scaleRatio, _scaleRatio);
    ...
    [UIView animateKeyframesWithDuration:self.backDuration delay:0.0 options:0 animations:^{
        if (_flipEnable) {
            ...
            [UIView addKeyframeWithRelativeStartTime:0.0 relativeDuration:1.0 animations:^{
                ...
                _toshadowView.transform = CGAffineTransformIdentity;
