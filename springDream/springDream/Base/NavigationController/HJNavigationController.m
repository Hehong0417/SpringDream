...
+ (void)setupNavigationBarTheme {
    ...
    textAttrs[NSFontAttributeName] = BoldFONT(16);
...
+ (void)setupBarButtonItemTheme
{
    ...
    /**设置文字属性**/
    // 设置普通状态的文字属性
    [appearance setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:APP_COMMON_COLOR, NSForegroundColorAttributeName,BoldFONT(16),NSFontAttributeName,nil] forState:UIControlStateNormal];
    ...
    [appearance setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:APP_COMMON_COLOR, NSForegroundColorAttributeName,BoldFONT(16),NSFontAttributeName,nil] forState:UIControlStateDisabled];
    /**自定义导航控制器返回按钮设置背景**/
