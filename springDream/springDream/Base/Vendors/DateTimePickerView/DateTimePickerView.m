...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        self.pickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, 40, [UIScreen mainScreen].bounds.size.width, 150)];
...
//        [upVeiw addSubview:cancelButton];
        ...
        chooseButton.titleLabel.font = FONT(15);
        [chooseButton setTitleColor:APP_COMMON_COLOR forState:UIControlStateNormal];
...
- (void)showDateTimePickerView{
    ...
    [UIView animateWithDuration:0.25f animations:^{
        self.alpha = 1;
        _contentV.frame = CGRectMake(0, screenHeight-180, screenWith, 180);
...
- (void)hideDateTimePickerView{
    ...
    [UIView animateWithDuration:0.2f animations:^{
        self.alpha = 0;
        _contentV.frame = CGRectMake(0, screenHeight, screenWith, 180);
    } completion:^(BOOL finished) {
